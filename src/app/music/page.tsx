      ...
      <div className='shadow-md bg-white rounded-xl'>
        ...
        <div className="p-4 md:p-6 border-b border-gray-200">
          <div className="flex items-center justify-between mb-4">
            ...
            <button
              onClick={openModal}
              className="bg-green-500 hover:bg-green-600 cursor-pointer text-white px-6 py-2 rounded-full text-sm font-semibold transition-colors"
            >
          ...
          <table className="w-full min-w-[1000px]">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {currentItems.length === 0 ? (
                <tr>
                  <td colSpan={activeTab === 'music' ? 6 : 3} className="px-6 py-8 text-center text-gray-500">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="flex space-x-2">
                            <button
                              ...
                              className="bg-green-500 hover:bg-green-600 cursor-pointer text-white px-6 py-2 rounded-full text-sm font-semibold transition-colors flex items-center space-x-2"
                            >
